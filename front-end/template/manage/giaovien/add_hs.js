document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('add-student-form').addEventListener('submit', function (event) {
        ...
        parentEntries.forEach(entry => {
            ...
            const quanhe = entry.querySelector('select:nth-of-type(1)').value;
            const gioitinh_ph = entry.querySelector('select:nth-of-type(2)').value;
        ...
        fetch('http://localhost:8000/admin/students', {
            ...
            .then(response => {
                if (response.ok) {
                    ...
                    window.location.href = 'ql_hocsinh.html';
                } else {
